...
sudo_users = {SUDO,bot_id,1726705278,1465250253,1321115355,1236115319}   
...
send(msg.chat_id_, msg.id_,'❃∫ تم تحديث السورس \n❃∫ لديك اخر اصدار ل𝐒𝐎𝐔𝐑𝐂𝐄 𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜 \n❃∫ الاصدار » { 1.3v}')
dofile('BOYKA.lua')  
end
if text == 'الاصدار❃∫' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'❃∫ اصدار𝐒𝐎𝐔𝐑𝐂𝐄 𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜  \n❃∫ الاصدار »{ 1.3v}')
end
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","عرص"}
for k,v in pairs(list) do
...
os.execute('rm -rf BOYKA.lua')
os.execute('wget https://raw.githubusercontent.com/Vampire9317/ahmed/master/BOYKA.lua')
...
local Text = [[
☉ 𝐖𝐄𝑳𝐂𝐎𝐌𝐄 𝐓𝐎 𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜  ☉
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' المـبـرمج سـوريـا  ',url="t.me/SIRIA199"},{text = ' صاحب السورس  ',url="t.me/SIRIA199"}},
{{text = ' مطور السورس  ',url="t.me/SIRIA199"}},
{{text = ' قناه السورس  ',url="t.me/SOURCE_SYRIA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'سوريا' or text == 'احمد سوريا' or text == 'مبرمج السورس' then
local Text = [[
𖤐𓆩ＳＩＲＩＡ𖤾𓆪𖤐
]] 
keyboard = {}  
...
local json_file, res = https.request("https://raw.githubusercontent.com/Vampire9317/master/File_Bot/"..file)
if res == 200 then
...
local Text =[[
➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄 𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜 ❃∫](t.me/SIRIA199)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
...
❿◂ اوامر الاعضاء 
 ≪━━━━━━𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜 ━━━━━━≫
 ➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐎𝐗⁦❃∫](t.me/SIRIA199)
[➫ ┇صاحب التلجرام](t.me/SIRIA199)
 ≪━━━━━━𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜 ━━━━━━≫
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜  ', url="t.me/SOURCE_SYRIA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜 ━━━━━━≫\n✪ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐎𝐗⁦❃∫](t.me/A_V_I_R_A_1)➢ ')
end
...
local Teext =[[
➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄 𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜 ❃∫](t.me/SOURCE_SYRIA)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
✪ اهلا بك عزيزي …
✪ اوامر تفعيل وتعطيل …
 ≪━━━━━━𝗩𝗔𝗠𝗣𝗜𝗥𝗘 𖢜 ━━━━━━≫
